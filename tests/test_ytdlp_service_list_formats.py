...
class TestYtDlpServiceListFormats(unittest.TestCase):
    ...
    def test_tiktok_auth_error_raises_access_denied(self):
        ...
        with patch.object(
            self.service, "extract", side_effect=Exception(error_msg)
        ), patch.object(
    ...
    def test_tiktok_auth_error_gallery_dl_direct_download(self):
        ...
        with patch.object(
            ...
            self.service, "_try_gallery_dl_video", return_value=("/tmp/video.mp4", None)
        ):
    ...
    def test_tiktok_auth_error_tikwm_direct_download(self):
        ...
        with patch.object(
            ...
            self.service, "_try_gallery_dl_video", return_value=(None, "gallery-dl 403")
        ), patch.object(
            self.service,
            "_try_tikwm_video",
