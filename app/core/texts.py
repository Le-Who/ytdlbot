...
class Texts:
    ...
    FETCH_ERROR_RETRY = "❌ Ошибка при получении данных. Попробуйте еще раз."
    TIMEOUT_UNAVAILABLE = "❌ Время ожидания истекло. Сервис недоступен."
    ACCESS_DENIED = "❌ Доступ запрещен. Контент может быть приватным или требуется авторизация."
    ...
    DATA_EXPIRED_RESEND = "⚠️ Данные устарели. Пожалуйста, отправьте ссылку на видео еще раз."
    ...
    SVC_FORMAT_UNAVAILABLE = "Выбранный формат или видео недоступны. Попробуйте другую ссылку."
