...
- **Telegram Event Loop**: Bound missing `apislide` regex routing rules to the `main.py` application builder, resolving a bug where TikTok gallery format buttons infinitely hung after clicking.
