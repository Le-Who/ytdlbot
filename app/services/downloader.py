                ...
                try:
                    ...
                    async with asyncio.timeout(300.0) as cm:
                        while True:
                            ...
                            # Optimization: Check bytes signature first to avoid expensive decoding
                            # Use lstrip() to handle potential leading whitespace or \r, ensuring robustness
                            if progress_callback and line.lstrip().startswith(b"[download]"):
